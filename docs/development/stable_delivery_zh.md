...
最新判断与逐项证据见 [0.3.0 本地验收结论](release_readiness_zh.md)：本地候选完成，
远端矩阵、合并和发布仍需授权。下方保留各切片历史，不覆盖最新结论。
...
| E 发行包 | 本地 0.3.0 完整门禁、同一 wheel 安装及校验和通过；公开版本仍为 0.2.0rc1 | 远端 CI、合并和发布待授权，本地准备已完成 |
